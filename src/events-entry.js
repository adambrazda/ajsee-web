...
function patchFilterVisuals() {
  ...
  injectOnce('ajsee-city-sheet-compact-favourites-css', String.raw`
    /* AJSEE_CITY_SHEET_COMPACT_FAVOURITES_CSS_ONLY_V1
       Show more favourite city rows on mobile.
       CSS-only: no pointer/click handler changes, no global click suppression. */
